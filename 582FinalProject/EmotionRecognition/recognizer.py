...
print("Your Neutral Score is: %.4f" % (emoNeut / (fileCount-1)))
print("Your Happiness Score is: %.4f" % (emoHapp / (fileCount-1)))
print("Your Sadness Score is: %.4f" % (emoSad / (fileCount-1)))
print("Your Anger Score is: %.4f" % (emoAnger / (fileCount-1)))
print("Your Fear Score is: %.4f" % (emoFear /  (fileCount-1)))
